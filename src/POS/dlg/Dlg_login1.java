...
//            validateTree();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(544, 265));
        ...
        jLabel4.setText("Sign in with your credentials ");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img3/logo2.jpg"))); // NOI18N
        jLabel5.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 120, 210));
        ...
        jPanel3.add(pnl_log, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 30, 20));
        ...
        jPanel3.add(jXPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 24, 23));
        ...
        jPanel3.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 120, 30));
...
//         do_set(" ");
    ...
    private void myInit() {
        ...
        jXPanel1.setVisible(false);
    }

    private void focus() {
        JTextField[] tf = {tf_username, pf_password};
...
//            Prompt.call("Wrong UserName/Password");
            Alert.set(0, "Wrong UserName/Password", this.getSurface());
            tf_username.setText("");
            pf_password.setText("");
            tf_user_name.setText("");
                    ...
                    if (user_level == 5 || user_level == 6) {
                        ...
                        if (strict_cashout.equals("true")) {
                            ...
                            if (check.equals("-1")) {
                                ...
                                Alert.set(0, "Wrong UserName/Password", this.
                                        getSurface());
                                tf_username.setText("");
                                pf_password.setText("");
                                tf_user_name.setText("");
