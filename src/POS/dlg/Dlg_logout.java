...
//            validateTree();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 750, 60));
        ...
        btn_clearall.setToolTipText("CLEAR");
        ...
        btn_clear.setToolTipText("CLOSE");
        ...
        jPanel6.add(btn_clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 80, 60));
        ...
        jPanel6.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 40, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("OK");
        jPanel6.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 60, 40, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("CLEAR");
        jPanel6.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 40, -1));

        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, 360, 80));
        ...
        pnl_numpad.add(btn_9, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 110, 80));
        ...
        pnl_numpad.add(btn_6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, 110, 80));
        ...
        pnl_numpad.add(btn_8, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 110, 80));
        ...
        pnl_numpad.add(btn_5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, 110, 80));
        ...
        pnl_numpad.add(btn_3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 110, 80));
        ...
        pnl_numpad.add(btn_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 110, 80));
        ...
        pnl_numpad.add(btn_0, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 230, 60));
        ...
        pnl_numpad.add(btn_dot, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 250, 110, 60));

        jPanel1.add(pnl_numpad, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 370, 320));
        ...
        jPanel3.add(lbl_cashcount, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 250, 50));
        ...
        jPanel3.add(tf_dollar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 250, 50));

        tf_credit.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        jPanel3.add(tf_credit, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 140, 220, 50));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setText("USD:");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1, 50));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setText("Php:");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 60, 50));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel4.setText("CREDIT:");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 110, 50));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 80, 360, 230));
...
//                btn_dot.doClick();
    ...
    private void initTfDummy() {
        ...
        tf_dummy2 = new JTextField();
        CurrencyDocument cd2 = new CurrencyDocument(true, 10);
        tf_dummy2.setDocument(cd2);
    }
    private JTextField tf_dummy;
    private JTextField tf_dummy1;
    private JTextField tf_dummy2;
    ...
    private void put_text(String str) {
        ...
        } else if (tf_credit.hasFocus()) {
            CurrencyDocument.decimalInserter(tf_dummy2, str);
            tf_credit.setText(tf_dummy2.getText());
        } else {
...
//        lbl_cashcount.setText("");
    ...
    private void prcss_work_on() {
        ...
        final double credit = FitIn.toDouble(tf_credit.getText());
...
//        double sales = S16_ret_cashier_sales.ret_sales(ses_id);
    ...
    private void do_ok1(int id, String user_name, double cash_out, double addtl_cash, double credit) {

        S11_cash_out.p_cash_count(id, cash_out, addtl_cash, credit);
