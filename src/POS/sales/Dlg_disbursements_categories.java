 ...
 * @author Guinness
 */
public class Dlg_disbursements_categories extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_disbursements_categories
     */
    ...
    public static class OutputData {
        ...
        public OutputData(String stmt, String date, String category, String type, int report) {
            this.stmt = stmt;
            this.date = date;
...
//</editor-fold>
    ...
    private Dlg_disbursements_categories(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_disbursements_categories(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_disbursements_categories() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_disbursements_categories myRef;

    private void setThisRef(Dlg_disbursements_categories myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_disbursements_categories> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_disbursements_categories create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_disbursements_categories create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_disbursements_categories dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_disbursements_categories((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_disbursements_categories((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_disbursements_categories dialog = Dlg_disbursements_categories.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jCheckBox6.setText("Summary");

        buttonGroup2.add(jCheckBox7);
        jCheckBox7.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jCheckBox7.setText("Itemized");
    ...
    private void myInit() {
        init_key();
        expenses = S1_expenses_categories.ret_where(" order by category_name asc ");
    }
...
//                btn_0.doClick();
    ...
    private void init_receipt_types() {
        ...
        tr.setCallback(new TableRenderer.Callback() {
            ...
            public void ok(TableRenderer.OutputData data) {
                ...
                jTextField1.setText(to.category_name.toUpperCase());
            }
        });
    }
    ...
    private void ok() {
        ...
        if (!jCheckBox2.isSelected()) {
            where = where + " and category_name like '%" + jTextField1.getText() + "%' ";
            category = jTextField1.getText();
        }
        ...
        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(where, date, category, type, report));
        }
    }
}
