...
drop table if exists db_pos_restaurant.cashouts;
create table db_pos_restaurant.cashouts(
    id int auto_increment primary key
    ,date_added datetime
    ,user_name varchar(100)
    ,amount double
...
drop table if exists db_pos_restaurant.addt_cashins;
create table db_pos_restaurant.addt_cashins(
    id int auto_increment primary key
    ,date_added datetime
    ,user_name varchar(100)
    ,amount double
...
drop table if exists db_pos_restaurant.billing_histories; 
create table db_pos_restaurant.billing_histories( 
id int auto_increment primary key
,room_id varchar(100) 
,room_name varchar(100) 
,guest_ids varchar(100) 
,guest_names varchar(100) 
