...
//        }
    ...
    private void edit() {
        ...
        int id = 0;
        final String date_added = DateType.datetime.format(dp_date.getDate());
        final String user_name = "";
        final String amount = "" + FitIn.toDouble(tf_amount.getText());
        final String purpose = tf_reason.getText();
//        if (purpose.isEmpty()) {
//            Prompt.call("Complete Details");
//            return;
//        }
...
//                throw new UnsupportedOperationException("Not supported yet.");
    ...
    private void delete() {
        ...
        final to_cashout to = (to_cashout) tbl_expenses_ALM.get(tbl_expenses.convertRowIndexToModel(idx));
        final to_cashout to1 = new to_cashout(to.id, "", "", "", "", 0);
        Window p = (Window) this;
        Dlg_authenticate nd = Dlg_authenticate.create(p, true);
        nd.setTitle("");
//        nd.do_pass("");
