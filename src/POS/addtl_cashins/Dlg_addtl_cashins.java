...
//          JOptionPane.showMessageDialog(null, user_name);
        ...
        loadData_expenses(S1_addtl_cashins.ret_data2(date, user_name));
    }
...
//            return;
//        }
        final S1_addtl_cashins.to_cashout to1 = new S1_addtl_cashins.to_cashout(to.id, date_added, user_name, amount, purpose, 0);
...
//                throw new UnsupportedOperationException("Not supported yet.");
    ...
    private void delete() {
        ...
        final S1_addtl_cashins.to_cashout to = (S1_addtl_cashins.to_cashout) tbl_expenses_ALM.get(tbl_expenses.convertRowIndexToModel(idx));
        final S1_addtl_cashins.to_cashout to1 = new S1_addtl_cashins.to_cashout(to.id, "", "", "", "", 0);
